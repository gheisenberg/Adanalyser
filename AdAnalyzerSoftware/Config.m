    ...
    methods
        ...
        function str = toString(self)
            ...
            str = [...
				...
				'EEG_DEVICE=',self.EEG_DEVICE,char(10),...
				'EDA_DEVICE=',self.EDA_DEVICE,char(10),...
				'HRV_DEVICE=',self.HRV_DEVICE,char(10),...
                'EEG_DEVICE_USED=',num2str(self.EEG_DEVICE_USED),char(10),...
                'EDA_DEVICE_USED=',num2str(self.EDA_DEVICE_USED),char(10),...
                'HRV_DEVICE_USED=',num2str(self.HRV_DEVICE_USED),char(10),...
